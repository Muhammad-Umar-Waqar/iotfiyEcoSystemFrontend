...
const CreateManager = () => {
  return (
    <div className="p-6 bg-white rounded-lg shadow-sm">
      <h1 className="text-2xl font-semibold text-gray-900 mb-4">Create Manager</h1>
      <p className="text-sm text-gray-600 mb-6">
        Use this component as a starting point for creating a manager or assigning plans.
      </p>
      <div className="space-y-4">
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-lg font-medium text-gray-800">Create Manager</h2>
          <p className="text-sm text-gray-600">Add a new manager and send a setup link via email.</p>
        </div>
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h2 className="text-lg font-medium text-gray-800">Assign Custom Plan</h2>
          <p className="text-sm text-gray-600">Assign or customize subscription plans for managers.</p>
        </div>
      </div>
    </div>
  );
